...
(setq ps-lpr-buffer "-p/home/burak/out.ps ")	; a tmp spool file
...
(easy-menu-define
  ...
  (list
   ...
   ["Tex Listings Python (File)" tempo-template-tex-listings-python-file]
   ["Tex Listings Python" tempo-template-tex-listings-python]
...
(set-frame-position (selected-frame) 340 0) ;emacs, ekranin "neresinde" baslamali
...
(find-file-other-window "/home/burak/Documents/kitaplar/code")
(find-file-other-window "/home/burak/data")
(find-file-other-window "/home/burak/Documents/classnotes/app-math-tr/emmix")

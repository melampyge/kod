...
dormant[data$last_visit > 150 & data$rank == data$per_customer_count] = 1
...
dormant[data.validate$last_visit > 150 & data.validate$rank == data.validate$per_customer_count] = 1
